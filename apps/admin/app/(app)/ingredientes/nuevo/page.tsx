        ...
        <ActionForm action={createIngredient} className="flex min-w-0 flex-col gap-4">
          <FormGrid>
            ...
            <TextInput
              ...
              min={0}
              defaultValue={0}
              hint="Para la alerta de reposición."
            />
          </FormGrid>
          ...
          <Checkbox
            ...
            name="is_available"
            defaultChecked
            hint="Desmárcalo si dejó de conseguirse."
          />

          <fieldset className="rounded-[var(--r-card)] border border-line p-4">
            <legend className="px-1 text-sm font-semibold">
              Precio de compra inicial (opcional)
            </legend>
            <p className="mb-3 text-xs text-muted">
              Precio pagado y contenido del empaque. El sistema calcula el costo por unidad base.
              Puedes usar kg / L / docena: se convierte automáticamente.
            </p>
            <FormGrid cols={4}>
