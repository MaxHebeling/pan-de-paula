          ...
          <TextInput
            ...
            hint={
              mode === "create"
                ...
                : "Cambiarlo rompe enlaces compartidos."
            }
          />
      ...
      <section className="flex flex-col gap-3">
        ...
        <FormGrid cols={3}>
          ...
          <TextInput
            ...
            hint="gluten, lácteos, huevo, nuez…"
          />
          <TextInput
            label="Etiquetas"
            name="tags"
            defaultValue={initial.tags.join(", ")}
            hint="nuevo, vegano, sin azúcar…"
          />
        </FormGrid>
        <FormGrid cols={3}>
          <TextInput
          ...
          />
          <TextInput
            label="Temporada desde"
            name="season_start"
            type="date"
            defaultValue={initial.season_start ?? ""}
          />
          <TextInput
            label="Temporada hasta"
            name="season_end"
            type="date"
            defaultValue={initial.season_end ?? ""}
          />
        </FormGrid>
      </section>
      ...
      <section className="flex flex-col gap-1">
        ...
        <div className="grid grid-cols-1 gap-x-6 md:grid-cols-2">
          <Checkbox
            ...
            hint="Inactivo: no se vende en ningún canal."
          />
          <Checkbox
            label="Destacado"
            name="is_featured"
            defaultChecked={initial.is_featured}
            hint="Aparece en la portada de la tienda."
          />
          <Checkbox
            label="Mostrar en tienda web"
            name="show_on_web"
            defaultChecked={initial.show_on_web}
          />
          <Checkbox
            label="Mostrar en POS"
            name="show_on_pos"
            defaultChecked={initial.show_on_pos}
          />
          <Checkbox
            label="Favorito en POS"
            name="pos_favorite"
            defaultChecked={initial.pos_favorite}
            hint="Acceso rápido en la pantalla de venta."
          />
          <Checkbox
            label="Controlar inventario"
            name="track_stock"
            defaultChecked={initial.track_stock}
            hint="Descuenta existencias al vender."
          />
          <Checkbox
            label="Permite pedido anticipado"
            name="allow_preorder"
            defaultChecked={initial.allow_preorder}
          />
          <Checkbox
            label="Solo bajo pedido"
            name="requires_preorder"
            defaultChecked={initial.requires_preorder}
            hint="No se vende de mostrador."
          />
        </div>
      </section>
