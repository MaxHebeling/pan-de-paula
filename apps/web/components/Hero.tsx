  ...
  return (
    <section className="cinematic-hero" data-hero>
      <Image
        ...
        alt="Tres croissants artesanales de El Pan de Paula"
        fill
        priority
        fetchPriority="high"
        quality={60}
      ...
      <div className="container-x cinematic-hero-content">
        ...
        <p className="hero-sub cinematic-copy">
          Croissants artesanales, horneados para tu fecha y terminados a mano, uno por uno.
        </p>
        <div className="hero-cta cinematic-actions">
          <Link href="/menu" className="btn cinematic-primary" data-testid="cta-menu" data-magnetic>
            Descubrir el menú <span aria-hidden="true">→</span>
          </Link>
          <Link href="/menu" className="btn cinematic-secondary" data-magnetic>
            Pedir ahora
          </Link>
        </div>
        <p className="hero-status cinematic-status" data-testid="open-status">
          ...
          {status.open ? (
            <span>
              ...
              {status.closesAt && <span> · cerramos a las {hour12(status.closesAt)}</span>}
            </span>
          ) : (
            <span>
      ...
      <div className="cinematic-scroll" aria-hidden="true">
