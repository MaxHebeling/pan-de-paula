...
| Clientes             | Sin login. `public_code` (PDP-000143) y `qr_token` opaco; resolución solo en backend (`find_customer`).                                                                                | Registro por QR en 30 segundos; el QR no expone datos.                                                                                                                                               |
...
Ver `DEPLOYMENT.md`, `ROLLBACK.md`, `BACKUP_RESTORE.md`, `RELIABILITY.md`.
